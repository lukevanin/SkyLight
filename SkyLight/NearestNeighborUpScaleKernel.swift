...
final class NearestNeighborUpScaleKernel {
    ...
    init(device: MTLDevice) {
        ...
        let function = library.makeFunction(name: "nearestNeighborUpScale")!
    ...
    func encode(
        ...
        precondition(outputTexture.width % inputTexture.width == 0)
        precondition(outputTexture.height % inputTexture.height == 0)
